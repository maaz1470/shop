...
?>
                ...
                <?= Config::inc('backend.inc.footer.mainfooter') ?>
        ...
        <!-- Right Sidebar -->
        <?= Config::inc('backend.inc.sidebar.right_sidebar') ?>
        <!-- /Right-bar -->
