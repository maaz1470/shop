...
<html lang="en">
    ...
    <body class="bg-pattern">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-8">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="">
                                    ...
                                    <form class="form-horizontal" method="POST" id="form" action='/check-login'>
                        ...
                        <div class="mt-5 text-center">
                            <p class="text-white-50">Don't have an account ? <a href="/admin/registration" class="fw-medium text-primary"> Register </a> </p>
        ...
        <script src="<?= Config::asset('backend/'); ?>js/app.js"></script>
            ...
            form.addEventListener('submit',function(e){
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        remember: e.target.elements.customControlInline.checked
                    },
                    success: function(msg){
                        const response = JSON.parse(msg);
                        if(response.status === 401 || response.status === 403){
                            if(Array.isArray(response.message)){
                                Swal.fire(response.message[0],response.message[1],'error')
                            }else{
                                Swal.fire('Error',response.message,'error')
                            }
                        }else if(response.status === 200){
                            if(Array.isArray(response.message)){
                                Swal.fire(response.message[0],response.message[1],'success');
                            }else{
