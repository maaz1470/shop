        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/admin/sub-sub-category/add-subcategory" class="btn btn-success">Add Sub Category</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <?php endif; ?>
                                            <a href="/admin/sub-sub-category/edit-subcategory/<?= $category->id ?>" class="btn btn-info btn-sm mx-2"><i class="fas fa-edit    "></i></a>
...
<script>
    function changeStatus(e,status,id){
        $.ajax({
            url: '/admin/sub-sub-category/statusChange',
            type: 'POST',
            data: {
                status: status,
                id: id
    ...
    function deleteCategory(e, id){
        Swal.fire(
            ...
            if(result.isConfirmed){
                $.ajax({
                type: 'POST',
                url:'/admin/subs-sub-category/delete',
                data: {
                    id: id
                },
                success: function (msg){
