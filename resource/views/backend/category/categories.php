            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                            <?php foreach($var['categories'] as $index => $category): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <?php else: ?>
                                            <button onclick="changeStatus(this,1,<?= $category->id ?>)" class="btn btn-warning btn-sm mx-2"><i class="fa fa-arrow-circle-down" aria-hidden="true"></i></button>
                                            <?php endif; ?>
                                            <a href="/admin/category/edit-category/<?= $category->id ?>" class="btn btn-info btn-sm mx-2"><i class="fas fa-edit    "></i></a>
...
<script>
    function changeStatus(e,status,id){
        $.ajax({
            url: '/admin/category/statuChange',
            type: 'POST',
            data: {
                status: status,
                id: id
